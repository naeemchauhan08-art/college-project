...
<body>
    ...
    <div class="container">
        ...
        <div class="auth-card" style="max-width: 1000px; margin: 0 auto; text-align: left;">
            ...
            <?php if (count($requests) > 0): ?>
                <table class="track-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="color: #333; font-weight: 500;"><?= htmlspecialchars($req['name']) ?></td>
                            <td style="color: #333; font-weight: 500;"><?= htmlspecialchars($req['title']) ?></td>
                            <td style="color: #000; font-weight: 600;"><strong><?= $req['copies_requested'] ?></strong></td>
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 40px; color: #333; background-color: #ffffff; border-radius: 8px;">
                    <i class="fas fa-check-circle" style="font-size: 3rem; color: #28a745; margin-bottom: 10px;"></i>
                    <p style="color: #333; font-weight: 500;">All caught up! No pending requests.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
